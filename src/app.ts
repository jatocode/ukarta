...
import * as THREE from 'three';
import { WebGLRenderer, Scene, PerspectiveCamera, OrbitControls } from 'three';


export class App {
  message = 'Testa ugnskarta!';
  ugnsKartaWidth = 1000;
  ugnsKartaHeight = 800;
...
//  this.controls = new THREE.OrbitControls(this.camera, this.renderer.dothislethisnt);
...
private createUgnBox = () => {
    ...
    var ugnWidth = me.operation.Resur.Bredd;
    var ugnHeight = me.operation.Resur.Hojd;
    var ugnLength = me.operation.Resur.Langd;
...
public addEventListenersForIndivids = () => {
    ...
    me.dragControls = new (<any>THREE).DragControls(me.meshObjectsInUgn, me.camera, me.renderer.domElement);
